	...
	array(
		...
		'fields' => array(
			array(
				...
				'desc'     => __( 'To unlock Vertical and more settings, <a href="https://shapedplugin.com/wp-tabs/?ref=1"  target="_blank"><b>Upgrade To Pro!</b></a>', 'wp-expand-tabs-free' ),
				'options'  => array(
					'horizontal' => array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'content' => __( 'To unlock the following Tabs Icon options, <a href="https://shapedplugin.com/wp-tabs/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'wp-expand-tabs-free' ),
			),
			array(
				'id'         => 'sptpro_tabs_icon',
				'type'       => 'switcher',
			...
			array(
				'type'    => 'notice',
				'class'   => 'only_pro_notice',
				'content' => __( 'To unlock the more settings for <b>Tabs Title and Description</b>, <a href="https://shapedplugin.com/wp-tabs/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'wp-expand-tabs-free' ),
			),
			array(
				'type'    => 'subheading',
			...
			array(
				'type'    => 'notice',
				'class'   => 'only_pro_notice',
				'content' => __( 'To unlock the following Tabs Animation settings, <a href="https://shapedplugin.com/wp-tabs/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'wp-expand-tabs-free' ),
			),
			array(
	...
	array(
		...
		'fields'          => array(
			array(
				...
				'content' => __( 'To unlock These Typography (940+ Google Fonts) options, <a href="https://shapedplugin.com/wp-tabs/?ref=1" target="_blank"><b>Upgrade To Pro</b></a>! P.S. Note: The color fields work in the lite version.', 'wp-expand-tabs-free' ),
			),
			array(
